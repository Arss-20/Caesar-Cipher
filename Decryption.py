...
#Window utama
jendela = Tk()
jendela.title('Dekripsi Caesar Cipher')
...
def main():
    ...
    ent3.insert(END, decrypted)

label = Label(jendela, text="DEKRIPSI CAESAR CIPHER\n", font=coun18)
label.pack()

label0 = Label(jendela, text="Setelah anda masukkan kata dan kunci,\nTekan 'Mulai Dekripsi' untuk memulai Dekripsi", font=coun12)
label0.pack()
...
tombol = Button(jendela, text="Mulai Dekripsi", font=coun10, command = main)
tombol.pack()
